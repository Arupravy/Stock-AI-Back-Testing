...
if st.sidebar.button("Run Backtest"):
    with st.spinner("Running backtest..."):
        ...
        for stock_name in selected_stock_names:
            ...
            st.markdown(f"## Backtest Results for {stock_name} ({stock_symbol})")
            backtest(stock_symbol, initial_capital, start_date, end_date, investment_type, strategy_type, transaction_cost, stop_loss_pct, take_profit_pct)
            st.markdown("---")
